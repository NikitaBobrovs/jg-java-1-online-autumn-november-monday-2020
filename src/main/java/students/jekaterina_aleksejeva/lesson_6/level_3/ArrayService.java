...
class ArrayServiceDemo {
    ...
    public static void main(String[] args) {
        ...
        int[] arrForSort = {99, -100, 4, -9, 11, 77};
        System.out.println("Array for sorting: " + Arrays.toString(arrForSort));
        demo.sort(arrForSort);
        System.out.println("Via Ascending sorted array: " + Arrays.toString(arrForSort));
