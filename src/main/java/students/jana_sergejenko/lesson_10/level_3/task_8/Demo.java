...
public class Demo {
    ...
    public String checkResult3(Optional<Product> result, Optional<Product> expected) {
    ...
    public void scenario3() {
        ...
        test.save(product);
        test.save(product1);
        Optional<Product> result = test.findByTitle2("Apple");
        Optional<Product> expected = test.findByTitle2("Apple");
        System.out.println("test" + checkResult3(result, expected));
