package students.jana_sergejenko.lesson_6.level_6.task_27;
...
public class TicTacToeTest {
    ...
    public void scenario16() {
        ...
        int[][] expected = {
                ...
                {-1, -1, -1},
                {-1, -1, -1}};
        int[][] result=array.createField();

        array.printFieldToConsole(result);
        array.printFieldToConsole(expected);
        checkTestResult((deepEquals(result, expected)), "createField");
    }
